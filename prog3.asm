...
int main(int argc, char *argv[]) {
   ...
   6:	83 ec 10             	sub    $0x10,%esp
        int i,k;
        if(lotto(40)==0)
   9:	c7 04 24 28 00 00 00 	movl   $0x28,(%esp)
  10:	e8 15 03 00 00       	call   32a <lotto>
...
int main(int argc, char *argv[]) {
  ...
  33:	c7 44 24 04 46 07 00 	movl   $0x746,0x4(%esp)
  3a:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 379:	0f b6 92 5d 07 00 00 	movzbl 0x75d(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 50f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 511:	b8 56 07 00 00       	mov    $0x756,%eax
...
free(void *ap)
{
 ...
 5d1:	a1 d4 09 00 00       	mov    0x9d4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 617:	89 10                	mov    %edx,(%eax)
  freep = p;
 619:	a3 d4 09 00 00       	mov    %eax,0x9d4
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 642:	a3 d4 09 00 00       	mov    %eax,0x9d4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 1d d4 09 00 00    	mov    0x9d4,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6a9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6ab:	3b 15 d4 09 00 00    	cmp    0x9d4,%edx
...
morecore(uint nu)
{
 ...
 6dd:	e8 ee fe ff ff       	call   5d0 <free>
  return freep;
 6e2:	8b 15 d4 09 00 00    	mov    0x9d4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 704:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 707:	89 15 d4 09 00 00    	mov    %edx,0x9d4
      return (void*)(p + 1);
 ...
 71c:	eb e9                	jmp    707 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 71e:	c7 05 d4 09 00 00 d8 	movl   $0x9d8,0x9d4
 725:	09 00 00 
    base.s.size = 0;
 728:	ba d8 09 00 00       	mov    $0x9d8,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 72d:	c7 05 d8 09 00 00 d8 	movl   $0x9d8,0x9d8
 734:	09 00 00 
    base.s.size = 0;
 737:	c7 05 dc 09 00 00 00 	movl   $0x0,0x9dc
 73e:	00 00 00 
